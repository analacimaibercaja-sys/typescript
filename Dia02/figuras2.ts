...
let miTriangulo1 = new Triangulo(3,8,2,6,4);
...
let miArrayDeFiguras: Figura [] = [miCuadrado1,new Cuadrado(5,5,7),miTriangulo1,new Circulo(7,4,3),
    miTriangulo1, new Triangulo(10,20,2,3,4), miRectangulo1, new Rectangulo(5,2,5,4)];

//miArrayDeFiguras.forEach(element => {
for (const element of miArrayDeFiguras) {
    console.log("x", element.x);
    console.log("y", element.y);
    console.log("Perímetro: ", element.damePerimetro());
    console.log("Superficie: ", element.dameSuperficie());
}